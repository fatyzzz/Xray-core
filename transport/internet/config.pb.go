...
type SocketConfig struct {
	...
	DialerOutboundTag          string               `protobuf:"bytes,24,opt,name=dialer_outbound_tag,json=dialerOutboundTag,proto3" json:"dialer_outbound_tag,omitempty"`
	DialerBalancerTag          string               `protobuf:"bytes,25,opt,name=dialer_balancer_tag,json=dialerBalancerTag,proto3" json:"dialer_balancer_tag,omitempty"`
...
func (x *SocketConfig) GetDialerOutboundTag() string {
	if x != nil {
		return x.DialerOutboundTag
	}
	return ""
}

func (x *SocketConfig) GetDialerBalancerTag() string {
	if x != nil {
		return x.DialerBalancerTag
	}
	return ""
}
...
const file_transport_internet_config_proto_rawDesc = "" +
	...
	"\x04type\x18\x06 \x01(\tR\x04type\"\xe9\t\n" +
	...
	"\fdialer_proxy\x18\t \x01(\tR\vdialerProxy\x12.\n" +
	"\x13dialer_outbound_tag\x18\x18 \x01(\tR\x11dialerOutboundTag\x12.\n" +
	"\x13dialer_balancer_tag\x18\x19 \x01(\tR\x11dialerBalancerTag\x125\n" +
